...
public class BrokenSwaggerTests
{
	...
	[TestCase(/*lang=json*/ "{swagger:{}}", "(1,10): Unexpected character")]
	[TestCase("swagger: {}", "(1,10): Failed to create an instance of type")]
	[TestCase(/*lang=json*/ "{swagger:'1.0'}", "(1,14): swagger should be '2.0'.")]
	[TestCase("swagger: '1.0'", "(1,15): swagger should be '2.0'.")]
	[TestCase(/*lang=json*/ "{swagger:'2.0'}", "(1,1): info is missing.")]
	[TestCase("swagger: '2.0'", "(1,1): info is missing.")]
	[TestCase(/*lang=json*/ "{swagger:'2.0',info:{}}", "(1,21): info/title is missing.")]
	[TestCase("swagger: '2.0'\ninfo: {}", "(2,7): info/title is missing.")]
	[TestCase(/*lang=json*/ "{swagger:'2.0',info:{title:' '}}", "(1,30): info/title is not a valid service name.")]
	[TestCase("swagger: '2.0'\ninfo:\n  title: ' '\n", "(3,13): info/title is not a valid service name.")]
	[TestCase(/*lang=json*/ "{swagger:'2.0',info:{title:' ','x-identifier':' '}}", "(1,49): info/x-identifier is not a valid service name.")]
